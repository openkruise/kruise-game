...
const (
	...
	// NodePort plugin events
	EventNetworkNodePortConfigParsed    = "network.nodeport.config.parsed"
	EventNetworkNodePortServiceCreated  = "network.nodeport.service.created"
	EventNetworkNodePortServiceUpdated  = "network.nodeport.service.updated"
	EventNetworkNodePortSelectorToggled = "network.nodeport.selector.toggled"
	EventNetworkNodePortStatusPublished = "network.nodeport.status.published"
	EventNetworkNodePortServiceDeleted  = "network.nodeport.service.deleted"
)
