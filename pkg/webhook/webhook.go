...
// +kubebuilder:rbac:groups=nlbpool.alibabacloud.com,resources=portallocations,verbs=get;list;watch;update;patch
// +kubebuilder:rbac:groups=nlbpool.alibabacloud.com,resources=portallocations/status,verbs=get;list;watch
